...
export const C = {
  bg: 'var(--canvas-bg)',
  bgSurface: 'var(--canvas-bg-surface)',
  bgPanel: 'var(--canvas-bg-panel)',
  bgHover: 'var(--canvas-bg-hover)',
  bgActive: 'var(--canvas-bg-active)',
  border: 'var(--canvas-border)',
  borderSubtle: 'var(--canvas-border-subtle)',
  text: 'var(--canvas-text)',
  textMuted: 'var(--canvas-text-muted)',
  textDim: 'var(--canvas-text-dim)',
  accent: 'var(--canvas-accent)',
  accentHover: 'var(--canvas-accent-hover)',
  accentSubtle: 'var(--canvas-accent-subtle)',
  green: '#22c55e',
  yellow: '#eab308',
  red: '#ef4444',
  orange: '#f97316',
