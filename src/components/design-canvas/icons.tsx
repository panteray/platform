...
export const DEVICE_SVG_STRINGS: Record<string, string> = {
  dome_camera: `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64" fill="none"><g transform="rotate(90 32 32)"><path d="M18 38 A14 14 0 0 1 46 38" stroke="#000" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M16 38 H48" stroke="#000" stroke-width="1.7"/><path d="M14 41 H50" stroke="#000" stroke-width="1.7"/><path d="M14 44 L50 44 L50 54 L14 54 Z" stroke="#000" stroke-width="2.5" fill="none"/><line x1="14" y1="49" x2="50" y2="49" stroke="#000" stroke-width="1.7"/><circle cx="32" cy="41" r="2.2" stroke="#000" stroke-width="1.7" fill="none"/></g></svg>`,
  ...
  turret_camera: `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64" fill="none"><g transform="rotate(-90 32 32)"><ellipse cx="32" cy="18" rx="18" ry="8" stroke="#000" stroke-width="2.5" fill="none"/><ellipse cx="32" cy="18" rx="12.5" ry="4.5" stroke="#000" stroke-width="1.7" fill="none"/><path d="M18 20 Q18 38 32 48 Q46 38 46 20" stroke="#000" stroke-width="2.5" fill="none"/><path d="M22 23 Q32 18 42 23" stroke="#000" stroke-width="1.7" fill="none"/><circle cx="32" cy="31" r="8.5" stroke="#000" stroke-width="1.7" fill="none"/><circle cx="32" cy="31" r="3.5" stroke="#000" stroke-width="1.7" fill="none"/><path d="M24 38 Q32 42 40 38" stroke="#000" stroke-width="1.7" fill="none"/></g></svg>`,

  ptz_camera: `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64" fill="none"><g transform="rotate(-90 32 32)"><path d="M24 16 H40 Q46 16 48 22 L50 28 Q50 34 44 36 H20 Q14 34 14 28 L16 22 Q18 16 24 16 Z" stroke="#000" stroke-width="2.5" fill="none"/><path d="M20 36 Q32 47 44 36" stroke="#000" stroke-width="2.5" fill="none"/><circle cx="32" cy="30" r="8" stroke="#000" stroke-width="1.7" fill="none"/><circle cx="32" cy="30" r="3" stroke="#000" stroke-width="1.7" fill="none"/><rect x="28" y="10" width="8" height="6" rx="2" stroke="#000" stroke-width="1.7" fill="none"/></g></svg>`,
  ...
  multisensor_dual: `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64" fill="none"><g transform="rotate(90 32 32)"><rect x="10" y="20" width="44" height="24" rx="12" stroke="#000" stroke-width="2.5" fill="none"/><circle cx="24" cy="32" r="9" stroke="#000" stroke-width="1.7" fill="none"/><circle cx="40" cy="32" r="9" stroke="#000" stroke-width="1.7" fill="none"/><rect x="28" y="21" width="8" height="4" fill="#000" stroke="none"/><rect x="28" y="39" width="8" height="4" fill="#000" stroke="none"/></g></svg>`,
