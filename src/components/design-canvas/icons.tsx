...
export const DEVICE_SVG_STRINGS: Record<string, string> = {
  // Dome: top-down plan view — circular housing with lens bubble
  dome_camera: `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><circle cx="32" cy="32" r="22" fill="#000" opacity="0.15"/><circle cx="32" cy="32" r="18" fill="#000" opacity="0.85"/><circle cx="32" cy="32" r="10" fill="#000"/><circle cx="32" cy="32" r="6" fill="#333" stroke="#555" stroke-width="1"/><circle cx="32" cy="32" r="2.5" fill="#888"/><line x1="14" y1="32" x2="10" y2="32" stroke="#000" stroke-width="1.5"/><line x1="50" y1="32" x2="54" y2="32" stroke="#000" stroke-width="1.5"/></svg>`,

  // Bullet: side-profile silhouette — cylindrical body with lens
  bullet_camera: `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><rect x="10" y="24" width="36" height="16" rx="3" fill="#000" opacity="0.85"/><rect x="44" y="22" width="10" height="20" rx="5" fill="#000"/><circle cx="49" cy="32" r="5" fill="#333"/><circle cx="49" cy="32" r="2.5" fill="#888"/><rect x="6" y="28" width="8" height="8" rx="1" fill="#000" opacity="0.5"/><rect x="30" y="20" width="4" height="4" rx="1" fill="#000" opacity="0.6"/></svg>`,

  // Turret / Eyeball: semi-sphere with exposed lens
  turret_camera: `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><circle cx="32" cy="34" r="18" fill="#000" opacity="0.15"/><path d="M16 38 Q16 16 32 14 Q48 16 48 38 Z" fill="#000" opacity="0.85"/><circle cx="32" cy="28" r="8" fill="#333"/><circle cx="32" cy="28" r="5" fill="#555"/><circle cx="32" cy="28" r="2" fill="#888"/><rect x="22" y="38" width="20" height="4" rx="2" fill="#000" opacity="0.4"/></svg>`,

  // PTZ: pendant-style dome with mount arm
  ptz_camera: `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><rect x="28" y="8" width="8" height="10" rx="2" fill="#000" opacity="0.6"/><circle cx="32" cy="30" r="18" fill="#000" opacity="0.85"/><circle cx="32" cy="30" r="14" fill="#222"/><circle cx="32" cy="30" r="8" fill="#333"/><circle cx="32" cy="30" r="4" fill="#555"/><circle cx="32" cy="30" r="1.5" fill="#888"/><path d="M14 30 A18 18 0 0 1 50 30" fill="none" stroke="#555" stroke-width="0.8"/><rect x="26" y="48" width="12" height="5" rx="2.5" fill="#000" opacity="0.5"/></svg>`,

  // Fisheye: flat circular disc with concentric lens rings
  fisheye_camera: `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><circle cx="32" cy="32" r="22" fill="#000" opacity="0.85"/><circle cx="32" cy="32" r="18" fill="#222"/><circle cx="32" cy="32" r="14" fill="#333" stroke="#444" stroke-width="0.5"/><circle cx="32" cy="32" r="9" fill="#444"/><circle cx="32" cy="32" r="5" fill="#555"/><circle cx="32" cy="32" r="2" fill="#888"/><circle cx="32" cy="32" r="22" fill="none" stroke="#000" stroke-width="1.5"/></svg>`,

  // Multi-sensor quad: 4 lens modules in a circular housing
  multisensor_quad: `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><circle cx="32" cy="32" r="22" fill="#000" opacity="0.85"/><circle cx="32" cy="32" r="22" fill="none" stroke="#000" stroke-width="1.5"/><rect x="20" y="20" width="10" height="8" rx="2" fill="#333"/><circle cx="25" cy="24" r="2" fill="#888"/><rect x="34" y="20" width="10" height="8" rx="2" fill="#333"/><circle cx="39" cy="24" r="2" fill="#888"/><rect x="20" y="36" width="10" height="8" rx="2" fill="#333"/><circle cx="25" cy="40" r="2" fill="#888"/><rect x="34" y="36" width="10" height="8" rx="2" fill="#333"/><circle cx="39" cy="40" r="2" fill="#888"/><line x1="32" y1="18" x2="32" y2="46" stroke="#222" stroke-width="1"/><line x1="18" y1="32" x2="46" y2="32" stroke="#222" stroke-width="1"/></svg>`,

  // Multi-sensor dual: 2 lens modules in elongated housing
  multisensor_dual: `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><ellipse cx="32" cy="32" rx="24" ry="14" fill="#000" opacity="0.85"/><ellipse cx="32" cy="32" rx="24" ry="14" fill="none" stroke="#000" stroke-width="1.5"/><rect x="12" y="26" width="14" height="12" rx="3" fill="#333"/><circle cx="19" cy="32" r="3" fill="#555"/><circle cx="19" cy="32" r="1.5" fill="#888"/><rect x="38" y="26" width="14" height="12" rx="3" fill="#333"/><circle cx="45" cy="32" r="3" fill="#555"/><circle cx="45" cy="32" r="1.5" fill="#888"/><line x1="32" y1="20" x2="32" y2="44" stroke="#222" stroke-width="0.8"/></svg>`,
