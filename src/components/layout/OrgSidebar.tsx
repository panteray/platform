...
import { LayoutDashboard, Settings, Users, Sliders, PanelLeftClose, PanelLeft, LogOut, Briefcase, Building2, Wrench, Factory, Truck, Cpu, PenTool, Calculator } from 'lucide-react'
...
const toolsNav = [
  ...
  { href: '/org/tools/calculators', label: 'Calculators', icon: Calculator, exact: false },
]
