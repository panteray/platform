...
export default function DistributorsPage() {
  ...
  return (
    <div>
      <div className="mb-6"><h1 className="font-display text-2xl font-bold tracking-tight">Distributors</h1><p className="mt-1 text-sm text-muted-foreground">Manage distributor accounts and purchasing relationships</p></div>
